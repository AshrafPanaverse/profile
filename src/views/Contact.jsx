...
const Contact = () => {
  ...
  return (
    <div
      ...
      className={
        darkMode
          ? "bg-gray-100 pt-5 md:h-screen"
          : "bg-black pt-5 text-white md:h-screen"
      }
    >
      <div className="max-w-7xl mx-auto x-4 sm:px-6 lg:px-8 px-4 ">
        ...
        <div className="flex justify-between items-center md:items-stretch  flex-col md:flex-row pb-5">
            ...
            <form>
              ...
              <div className="flex justify-between ">
                ...
                <button className="bg-indigo-500 text-white px-4 py-2 w-40 rounded-md hover:bg-indigo-400">
                  <a href="mailto:itskerisi786@gmail.com">Submit</a>
                </button>
              </div>
            </form>
          </div>
