      ...
      <div className="max-w-7xl mx-auto x-4 sm:px-6 lg:px-8 px-4 md:mt-0 pt-24 pb-12">
        ...
        <div>
          <motion.div>
            ...
            >
              I'm an experienced full-stack web developer and Mobile App Developer with
              experience in designing new features from ideation to production,
              implementation of wireframes and design flows into high
              performance software applications using the latest technologies and approaches. 
              ...
              release.<br/><br/>
              Let's connect and embark on an exciting journey to explore collaboration opportunities in the realms of Modern Web, Mobile Apps, Gen AI, and Web3 development!
            </p>
          </motion.div>
          <motion.div
          >
